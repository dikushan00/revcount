    ...
    return <MainLayOut title={"Add edit"}>
        <section className="edit">
            <div className="edit__header">
                ...
                <button className="edit__btn btn-2">
            ...
            <form action="#" className="edit__form border-wrap form-edit">
                <div className="form-edit__header">
                    <h4 className="form-edit__label">
                        Edit name
                    </h4>
                    <div className="form-edit__box">
                        <input className="form-edit__input" type="text" name="edit-name" placeholder="Write name here"/>
                    </div>
                </div>
                <div className="form-edit__wrapper">
                    ...
                    <ol className="task-edits__list">
                        <li className="task-edits__item">
                            <div className="task-edits__top">
                                <div className="task-edits__number"/>
                                <div className="task-edits__box">
                                    <div className="task-edits__wrap">
                                        <div className="task-edits__wrapper">
                                            <input type="file" name="file" id="input__file" className="task-edits__file"
                                                   multiple/>
                      ...
                      <svg width={20} height={18} viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            fill="#888BA0"/>
                                ...
                                <div className="task-edits__blosk">
                                    <button className="task-edits__edit">Edit</button>
                                    <button className="task-edits__delete">Delete</button>
                                </div>
                            </div>
                            <div className="task-edits__body">
                            <textarea className="task-edits__textarea" name="describe"
                                      placeholder="Describe the task clearly..." defaultValue={""}/>
                            </div>
                        </li>
                        <li className="task-edits__item task-open">
                            <div className="task-edits__top">
                                <div className="task-edits__number"/>
                                <div className="task-edits__box">
                                    <div className="task-edits__wrap">
                ...
                <div className="task-edits__inner">
                    <button className="task-edits__btn btn-2">Add new task <span>+</span></button>
                    <button className="task-edits__btn-correction btn">Add correction to project</button>
                </div>
            </form>
        </section>
    </MainLayOut>
