                ...
                <div className="signup__content">
                    <form onSubmit={handleSubmit(onSubmit)} action="/" className="signup__form">
                        ...
                        <p className="signup__descr">
                            If&nbsp;you already have an&nbsp;account&nbsp;— <Link href="/"><a
                        ...
                        <div className="signup__line">
                            <input ref = {register} required={true} onFocus={() => setIsPasswordValid(true)} name = "password" className="signup__input" placeholder="Password" type="password"/>
                            {
...
const AppleIcon = () => <svg width={30} height={30} viewBox="0 0 30 30" fill="none"
...
const GoogleIcon = () => <svg width={30} height={30} viewBox="0 0 30 30" fill="none"
                               xmlns="http://www.w3.org/2000/svg">
    <path
...
const FaceBookIcon = () => <svg width={30} height={30} viewBox="0 0 30 30" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
    <path
