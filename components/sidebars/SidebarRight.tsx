...
export const SidebarRight = () => {
    ...
    return <>
        <div className="page__sidebar sidebar-page">
            <div className="sidebar-page__team-project team-project ">
                <div className="team-project__header">
                    ...
                    <button className="team-project__settings" onClick={() => setIsModalMode(state => ({...state, teamSettings: true}))}>
            ...
            <div className="sidebar-page__actions notices">
                ...
                <ul className="notices__list">
                    ...
                    <li className="notices__item">
                        <div className="notices__text">
                            Adam has added a new edit <span
                            className="notices__text-span">«Molecular illustration»</span>
                        </div>
                        <div className="notices__time">
                            23:41
                        </div>
        ...
        }
        {
            ...
            <TeamSettingsModal hideBlock={() => setIsModalMode(state => ({...state, teamSettings: false}))}/>
        }
    </>
}
