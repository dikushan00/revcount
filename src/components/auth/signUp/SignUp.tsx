...
import signUpImg from "../../../assets/img/main/signup-img.svg"
        ...
        <header className="header-signup">
            <div className="header-signup__content _container">
                <div className="header-signup__logo">
                    <Link className="header-signup__logo-link" to="/">
                        <picture>
                    ...
                    <nav className="header-signup__body">
                        <ul className="header-signup__list">
                            <li className="header-signup__item">
                                <Link to="/" className="header-signup__link">How it
                                works</Link></li>
                            <li className="header-signup__item">
                                <Link to="/" className="header-signup__link">Storytelling</Link>
                            </li>
                            <li className="header-signup__item">
                                <Link to="/" className="header-signup__link">Benefits</Link>
                            </li>
                            <li className="header-signup__item">
                                <Link to="/" className="header-signup__link">Features</Link>
                            </li>
                            <li className="header-signup__item">
                                <Link to="/" className="header-signup__link">More about payment</Link>
                            </li>
                        </ul>
                    </nav>
                </div>
            ...
            <div className="_container">
                <nav className="breadcrumbs">
                    <ul className="breadcrumbs__list">
                        <li>
                            <Link to="/home" className="breadcrumbs__link">Home</Link>
                        </li>
                        <li>
                ...
                <div className="signup__content">
                    <form action="/" className="signup__form">
                        ...
                        <p className="signup__descr">
                            If&nbsp;you already have an&nbsp;account&nbsp;— <Link to="/"
                                                                                  className="signup__link">Login</Link>
                        </p>
                    ...
                    <div className="signup__images">
                        <picture>
                            <source srcSet={signUpImg} type="image/webp"/>
                            <img src={signUpImg} alt="signup"/></picture>
                    </div>
                </div>
            </div>
        </section>
