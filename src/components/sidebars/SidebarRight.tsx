    ...
    return <>
        ...
        <div className="sidebar-page__actions notices">
            ...
            <ul className="notices__list">
                <li className="notices__item">
                    <div className="notices__text">
                        Adam requested an&nbsp;offer to&nbsp;edit <span className="notices__text-span">«Logo Editing»</span>
                    </div>
                ...
                <li className="notices__item">
                    <div className="notices__text">
                        John sent the offer to&nbsp;edit <span className="notices__text-span">«Logo Editing»</span>
                        <span className="notices__span notices__span--1">280$</span>
                        <span className="notices__span notices__span--2">7d.</span>
                        <span className="notices__span notices__span--3">21h.</span>
                    </div>
                    <div className="notices__time">
                        22:17
                    </div>
                ...
                <li className="notices__item">
                    <div className="notices__text">
                        Adam has added a new edit <span className="notices__text-span">«Molecular illustration»</span>
                    </div>
                    <div className="notices__time">
                        23:41
                    </div>
        ...
        {
            isModalMode.inviteMember && <AddMemberToProjectModal hideBlock={() => setIsModalMode(state => ({...state, inviteMember: false}))} />
        }
</>
}
